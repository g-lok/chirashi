...
func init() {
	...
	rootCmd.Flags().StringVarP(&outputFormat, "format", "f", "wav", "Output format: wav, pti, ot, aif, aiff, aif-op1, 8svx, 16sv, tx16w, caf, xy, el, dt2pst, xrni, adv, als, adg, sfz, ds, xpm, multisample, bw, sp404, sp404mk2, pgm")
